...
# this uses the model defined in the Dockerfile ENV variable. If you dont use docker or docker based mgflows such as k8s, the default embedding model will be used (sentence-transformers/all-MiniLM-L6-v2)
...
TIKA_SERVER_URL = PersistentConfig(
    "TIKA_SERVER_URL",
    "rag.tika_server_url",
    os.getenv("TIKA_SERVER_URL", "http://tika:9998"),  # Default for sidecar mgflow
)
