...
# Removed CHANGELOG.md loading and parsing for container startup reliability
...
ALDEN_BUILD_HASH = os.environ.get("ALDEN_BUILD_HASH", "dev-build")
...
ENABLE_AUTH0 = os.environ.get("ENABLE_AUTH0", "True").lower() == "true"

# Auth0 domain (e.g., "mindgarden.us.auth0.com")
AUTH0_DOMAIN = os.environ.get("AUTH0_DOMAIN", "mindgarden.us.auth0.com")

# Auth0 client ID
AUTH0_CLIENT_ID = os.environ.get("AUTH0_CLIENT_ID", None)

# Auth0 API identifier (audience)
AUTH0_API_IDENTIFIER = os.environ.get("AUTH0_API_IDENTIFIER", None)
...
AUTH0_REDIRECT_URI = os.environ.get("AUTH0_REDIRECT_URI", None)
